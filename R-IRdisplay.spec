...
Version  : 1.0
Release  : 51
URL      : https://cran.r-project.org/src/contrib/IRdisplay_1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/IRdisplay_1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611428194
